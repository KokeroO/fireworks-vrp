...
AddEventHandler("fireworks:caseStart", function(x, y, z)
	...
	for i=1,shots do
		...
		StartParticleFxNonLoopedAtCoord("scr_indep_firework_trailburst", x, y, z, 0.0, 0.0, 0.0, 2.8, false, false, false)
		Wait(900)
		UseParticleFxAssetNextCall(cfg.particles.caseExtra)
		StartParticleFxNonLoopedAtCoord("scr_indep_firework_air_burst", x, y, z+70.0, 0.0, 0.0, 0.0, 1.0, false, false, false)
		Wait(timeStep)
	end
	Wait(10000)
	DeleteObject(prop)
...
AddEventHandler("fireworks:batteryStart", function(x, y, z)
	...
	for i=1,shots do
		...
		StartParticleFxNonLoopedAtCoord("scr_indep_firework_starburst", x, y, z, 0.0, 0.0, 0.0, math.random() * 0.5 + 0.8, false, false, false)
		Wait(timeStep)
	end
	Wait(10000)
	DeleteObject(prop)
...
AddEventHandler("fireworks:coneStart", function(x, y, z)
	...
	Wait(8000)
	for i=1,10 do
		StartParticleFxNonLoopedAtCoord("scr_indep_firework_fountain", x, y, z, 0.0, 0.0, 0.0, math.random() * 0.5 + 0.5, false, false, false)
		UseParticleFxAssetNextCall(cfg.particles.cone)
		StartParticleFxNonLoopedAtCoord("scr_indep_firework_shotburst", x, y, z, 0.0, 0.0, 0.0, math.random() * 0.5 + 0.8, false, false, false)
		Wait(5000)
	end
	Wait(10000)
	DeleteObject(prop)
